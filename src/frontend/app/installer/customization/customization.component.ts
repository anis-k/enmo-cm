...
export class CustomizationComponent implements OnInit {
    ...
    constructor(
        ...
        this.stepFormGroup = this._formBuilder.group({
            ...
            homeMessage: ['<p>D&eacute;couvrez <strong>Enmo-Cm</strong> avec <a title="notre guide de visite" href="https://docs.maarch.org/" target="_blank"><span style="color:#f99830;"><strong>notre guide de visite en ligne</strong></span></a>.</p>'],
